...
commits_verified: ["222a67c", "8d0ebaeb", f2463b5, "34c1fcc"]
...
- [x] Manual review complete (QA dossier `.agents/docs/archive/coverage-backend-manual-review-acp-provider-support.md`).
- [ ] Rebase onto `main` after PR #6 lands.
- [ ] Final no-mistakes review after rebase.
