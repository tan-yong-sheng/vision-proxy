...
- 2026-08-18: new research research/backend-image-format-crop-decoder-gap.md
- 2026-08-18: new plan plans/backend-image-format-support-and-crop-decoder.md
- 2026-08-18: scaffold-worktrees plans/backend-image-format-support-and-crop-decoder.md -> worktrees/backend-replace-imagescript-dependency-with-sharp-update-safecropimage-encodecroppedimag.md
- 2026-08-18: scaffold-worktrees plans/backend-image-format-support-and-crop-decoder.md -> worktrees/backend-add-content-sniffing-in-readimagefilewithreason-using-sharp.md
- 2026-08-18: scaffold-worktrees plans/backend-image-format-support-and-crop-decoder.md -> worktrees/backend-implement-url-download-helper-in-readimagefilewithreason.md
- 2026-08-18: scaffold-worktrees plans/backend-image-format-support-and-crop-decoder.md -> worktrees/backend-add-transient-error-classification-retry-in-generatewithfallback.md
- 2026-08-18: scaffold-worktrees plans/backend-image-format-support-and-crop-decoder.md -> worktrees/backend-update-help-text-if-url-not-implemented-decision-point.md
- 2026-08-18: scaffold-worktrees plans/backend-image-format-support-and-crop-decoder.md -> worktrees/backend-unit-tests-for-crop-on-all-10-formats-content-mismatch-url-transient-retry.md
