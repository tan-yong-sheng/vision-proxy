...
- WebP/BMP/ICO/AVIF: "crop failed" (unsupported by imagescript) verified-by:grep -n "safeCropImage\|Image.decode" src/core.ts; grep -n "static async decode\|class GIF" .local/share/vision-proxy/v0.1.0-rc.2/node_modules/imagescript/ImageScript.js
...
### URL input dead code
Help text says `<paths> or URLs` but `mimeTypeForExt("https://...")` returns undefined, yielding "unsupported extension". URL handling is not implemented. verified-by:grep -n "mimeTypeForExt" src/core.ts
